...
This skill is the defect-scattering companion to
[mat-epw-mobility](../mat-epw-mobility/SKILL.md), which computes the
*phonon*-limited mobility. At finite temperature the two channels combine by
Matthiessen's rule, $1/\mu_{\text{total}} = 1/\mu_{\text{phonon}} + 1/\mu_{\text{defect}}$.
Defect *energetics* (formation energies, charge states) that set which defects
dominate come from
[mat-defect-energy](../mat-defect-energy/SKILL.md); the AMSET route in
[mat-dft-electronic-transport](../mat-dft-electronic-transport/SKILL.md) is an
alternative phonon-limited channel.
...
[mat-epw-mobility](../mat-epw-mobility/SKILL.md)). Both are evaluated on the SAME
